...
for name, model in models.items():
    ...
    if name == "Random Forest":
        ...
        joblib.dump(pipeline, "model/house_price_model.pkl", compress=3)
# Plot MSE
...
plt.legend()
plt.tight_layout()
plt.savefig("model/actual_vs_predicted.png")
plt.show()
...
plt.tight_layout()
plt.savefig("model/correlation_heatmap.png")
plt.show()
